...
// public static int(스태틱) -> public int(인스턴스) 메소트로 만들기 
	public int register(Scanner input, ArrayList<HashMap<String, String>> haksaList, int protocol) { //등록 함수 만들기 
  ...
  public void search (Scanner input, ArrayList<HashMap<String, String>> haksaList) { // 찾기 함수 
  ...
  public void delete (Scanner input, ArrayList<HashMap<String, String>> haksaList) { //삭제 함수
 ...
 public void list (ArrayList<HashMap<String, String>> haksaList) { //전체 출력 함수
