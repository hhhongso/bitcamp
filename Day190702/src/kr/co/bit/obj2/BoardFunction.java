...
public class BoardFunction {
	...
	public void register(BufferedReader br, Connection conn) throws SQLException, IOException {
	...
	public void search(BufferedReader br, Connection conn) throws SQLException, IOException {
