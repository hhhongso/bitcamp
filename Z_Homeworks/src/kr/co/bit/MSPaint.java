...
class MSPaint extends JFrame {
	...
	private ArrayList<ShapeDTO> list1, list2;
	...
	public ArrayList<ShapeDTO> getArrayList(){ return list1;	}
			...
			public void mouseReleased(MouseEvent e){
				if(line.isSelected()){
					list1.add(new ShapeDTO(Integer.parseInt(x1T.getText()), Integer.parseInt(y1T.getText()), Integer.parseInt(x2T.getText()), Integer.parseInt(y2T.getText()), 
							Integer.parseInt(z1T.getText()), Integer.parseInt(z2T.getText()), fill.isSelected(), ShapeDTO.LINE, combo.getSelectedIndex()));
				} else if(circle.isSelected()){
					list1.add(new ShapeDTO(Integer.parseInt(x1T.getText()), Integer.parseInt(y1T.getText()), Integer.parseInt(x2T.getText()), Integer.parseInt(y2T.getText()), 
							Integer.parseInt(z1T.getText()), Integer.parseInt(z2T.getText()), fill.isSelected(), ShapeDTO.CIRCLE, combo.getSelectedIndex()));
				} else if(rect.isSelected()){
					list1.add(new ShapeDTO(Integer.parseInt(x1T.getText()), Integer.parseInt(y1T.getText()), Integer.parseInt(x2T.getText()), Integer.parseInt(y2T.getText()), 
							Integer.parseInt(z1T.getText()), Integer.parseInt(z2T.getText()), fill.isSelected(), ShapeDTO.RECT, combo.getSelectedIndex()));
				} else if(roundRect.isSelected()){
					list1.add(new ShapeDTO(Integer.parseInt(x1T.getText()), Integer.parseInt(y1T.getText()), Integer.parseInt(x2T.getText()), Integer.parseInt(y2T.getText()), 
							Integer.parseInt(z1T.getText()), Integer.parseInt(z2T.getText()), fill.isSelected(), ShapeDTO.ROUNDRECT, combo.getSelectedIndex()));
				} else if(pen.isSelected()){
					list1.add(new ShapeDTO(Integer.parseInt(x1T.getText()), Integer.parseInt(y1T.getText()), Integer.parseInt(x2T.getText()), Integer.parseInt(y2T.getText()), 
							Integer.parseInt(z1T.getText()), Integer.parseInt(z2T.getText()), fill.isSelected(), ShapeDTO.PEN, combo.getSelectedIndex()));
				} 			
			}
		});
